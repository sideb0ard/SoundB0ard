...
void sequence_engine_set_midi_note(sequence_engine *base, int midi_note_idx, int root_key);

void sequence_engine_clear_pattern_ready_for_new_one(sequence_engine *base,
                                               int pattern_num);
void sequence_engine_set_multi_pattern_mode(sequence_engine *self, bool pattern_mode);
void sequence_engine_set_pattern_loop_num(sequence_engine *self, int pattern_num,
                                    int loop_num);

int sequence_engine_add_pattern(sequence_engine *self);
void sequence_engine_dupe_pattern(midi_pattern *from, midi_pattern *to);
void sequence_engine_switch_pattern(sequence_engine *self, unsigned int pattern_num);
void sequence_engine_stop(sequence_engine *base);
void sequence_engine_reset_pattern(sequence_engine *self, unsigned int pattern_num);
...
void sequence_engine_pattern_to_string(sequence_engine *self, int pattern_num,
                                 wchar_t scratch[33]);
void sequence_engine_add_event(sequence_engine *self, int pattern_num, int midi_tick,
                         midi_event ev);
void sequence_engine_delete_event(sequence_engine *base, int pat_num, int tick);

void sequence_engine_print_patterns(sequence_engine *base);
void sequence_engine_nudge_pattern(sequence_engine *base, int pattern_num, int sixteenth);
...
void sequence_engine_set_chord_mode(sequence_engine *base, bool b);
...
int sequence_engine_change_octave_pattern(sequence_engine *base, int pattern_num,
                                    int direction);
void sequence_engine_change_octave_midi_notes(sequence_engine *base,
                                        unsigned int direction);
int sequence_engine_get_num_patterns(void *self);
void sequence_engine_set_num_patterns(void *self, int num_patterns);
int sequence_engine_get_num_notes(sequence_engine *base);
void sequence_engine_make_active_track(void *self, int pattern_num);

void sequence_engine_add_note(sequence_engine *base, int pattern_num, int step,
                        int midi_note, int amp, bool keep_note);
void sequence_engine_rm_note(sequence_engine *base, int pattern_num, int step);
void sequence_engine_mv_note(sequence_engine *base, int pattern_num, int fromstep,
                       int tostep);
void sequence_engine_add_micro_note(sequence_engine *base, int pattern_num, int step,
                              int midi_note, int amp, bool keep_note);
void sequence_engine_rm_micro_note(sequence_engine *base, int pattern_num, int step);
void sequence_engine_mv_micro_note(sequence_engine *base, int pattern_num, int fromstep,
                             int tostep);
...
int sequence_engine_get_octave(sequence_engine *base);

void sequence_engine_enable_arp(sequence_engine *base, bool b);
...
void sequence_engine_do_arp(sequence_engine *base, soundgenerator *sg);
