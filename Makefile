...
SRC = main.c mixer.c oscil.c envelope.c cmdloop.c audioutils.c bpmrrr.c table.c algoriddim.c utils.c fm.c drumr.c sbmsg.c sound_generator.c effect.c sampler.c help.c bitwize.c
