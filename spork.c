...
void spork_status(void *self, wchar_t *ss)
{
    ...
    swprintf(ss, MAX_PS_STRING_SZ, WANSI_COLOR_GREEN
             ...
             s->m_volume, s->m_lfo.osc.m_osc_fo, s->m_lfo.osc.m_octave,
             s->m_lfo.osc.m_semitones, s->m_lfo.osc.m_cents,
             s->m_osc1.osc.m_osc_fo, s->m_osc1.osc.m_octave,
             s->m_osc1.osc.m_semitones, s->m_osc1.osc.m_cents,
             s->m_osc2.osc.m_osc_fo, s->m_osc2.osc.m_octave,
             s->m_osc2.osc.m_semitones, s->m_osc2.osc.m_cents,
             s->m_osc3.osc.m_osc_fo, s->m_osc3.osc.m_octave,
             s->m_osc3.osc.m_semitones, s->m_osc3.osc.m_cents);
