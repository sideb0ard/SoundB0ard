...
char* rev_lookup[12] = {"c", "c#", "d", "d#", "e", "f", "f#", "g", "g#", "a", "a#", "b"}; 
...
int main(int argc, char **argv)
{
  ...
  int root_note_num = notelookup(argv[1]);
  int second_note_num = (root_note_num + 4) % 12;
  int third_note_num = (second_note_num + 3) % 12;
  printf("Chord is %s %s %s\n", rev_lookup[root_note_num], rev_lookup[second_note_num], rev_lookup[third_note_num]);
  //printf("Freaks! %lf %lf %lf\n", freqval(rev_lookup[root_note_num]"4"), freqval(rev_lookup[second_note_num]"4"), freqval(rev_lookup[third_note_num]"4"));
