...
void print_help()
{
    ...
    printf("open <filename> -- open <filename> as current project. (Overrides "
           "current)\n");
    ...
    printf("seq <sound_gen_no> change <pattern>\n");
    printf("\n");
    ...
    printf("\n");
    printf(
        "play <sample> [16th] -- optional 16th, otherwise plays immediately\n");
    printf("\n");
    printf("syn nano\n");
    printf("syn korg\n");
    printf("syn poly\n");
