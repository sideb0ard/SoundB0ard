...
DrumSynth::DrumSynth() {
  osc_eg_.SetEgMode(ANALOG);
  osc_eg_.SetAttackTimeMsec(1);
  osc_eg_.SetDecayTimeMsec(550);
  osc_eg_.SetRampMode(true);
  osc_eg_.Update();

  amp_eg_.SetEgMode(DIGITAL);
  amp_eg_.SetAttackTimeMsec(1);
  amp_eg_.SetDecayTimeMsec(550);
  amp_eg_.SetRampMode(true);
  amp_eg_.Update();

  noise_eg_.SetEgMode(DIGITAL);
  noise_eg_.SetAttackTimeMsec(1);
  noise_eg_.SetDecayTimeMsec(2);
  ...
  osc1_filter_ = std::make_unique<CKThreeFive>();
  osc1_filter_->SetFcControl(18000);
  osc1_filter_->SetQControlGUI(1);
  osc1_filter_->Update();
...
StereoVal DrumSynth::GenNext(mixer_timing_info tinfo) {
  ...
  if (osc1_->m_note_on) {
    ...
    osc1_->Update();
    // std::cout << "OSC1: freq:" << osc1_->m_fo << " inc:" << osc1_->m_inc
    //           << std::endl;
...
std::string DrumSynth::Info() {
  ...
  //     << " detune:" << settings_.detune_cents << " osc2.cents:" <<
  //     osc2_->m_cents
  //     << " pw:" << settings_.pulse_width_pct << " pb:" <<
  //     settings_.pitch_bend
  //     << std::endl;
  //  ss << "     osc1:" << GetOscType(settings_.osc1_wav) << "("
  //     << settings_.osc1_wav << ")"
  //     << " o1amp:" << settings_.osc1_amp << " o1ratio:" <<
  //     settings_.osc1_ratio
  ...
  //     << settings_.osc2_wav << ")"
  //     << " o2amp:" << settings_.osc2_amp << " o2ratio:" <<
  //     settings_.osc2_ratio
  ...
  //     << settings_.osc3_wav << ")"
  //     << " o3amp:" << settings_.osc3_amp << " o3ratio:" <<
  //     settings_.osc3_ratio
  ...
  //  ss << COOL_COLOR_PINK2 << "     eg_attack:" << settings_.amp_eg_attack_ms
  //     << " eg_decay:" << settings_.amp_eg_decay_ms
  //     << " eg_ramp:" << settings_.amp_eg_ramp_mode << std::endl;
  //  ss << COOL_COLOR_PINK2
  ...
  //  << std::endl;
  //  ss << "     lfo_filter1_q:" << settings_.lfo_filter1_q_enable <<
  //  std::endl; ss << "     lfo_filter2_fc:" <<
  //  settings_.lfo_filter2_freq_enable
  //     << std::endl;
  //  ss << "     lfo_filter2_q:" << settings_.lfo_filter2_q_enable <<
  //  std::endl; ss << "     lfo_filter3_fc:" <<
  //  settings_.lfo_filter3_freq_enable
  //     << std::endl;
  //  ss << "     lfo_filter3_q:" << settings_.lfo_filter3_q_enable <<
  //  std::endl; ss << "     lfo_master_fc:" <<
  //  settings_.lfo_master_filter_freq_enable
  //     << std::endl;
...
void DrumSynth::Save(std::string new_preset_name) {
  ...
  //     std::cerr << "Play tha game, pal, need a name to save yer synth
  //     settings"
  //               << std::endl;
  //     return;
  //   }
  ...
  //             << kSEP;
  //   presetzzz << "master_filter_type=" << settings_.master_filter_type <<
  //   kSEP; presetzzz << "master_filter_fc=" << settings_.master_filter_fc <<
  //   kSEP; presetzzz << "master_filter_q=" << settings_.master_filter_q <<
  //   kSEP; presetzzz << "eg_attack_ms=" << settings_.eg_attack_ms << kSEP;
  ...
  //             << kSEP;
  //   presetzzz << "eg_filter1_freq_enable=" <<
  //   settings_.eg_filter1_freq_enable
  //             << kSEP;
  //   presetzzz << "eg_filter1_q_enable=" << settings_.eg_filter1_q_enable <<
  //   kSEP; presetzzz << "eg_filter2_freq_enable=" <<
  //   settings_.eg_filter2_freq_enable
  //             << kSEP;
  //   presetzzz << "eg_filter2_q_enable=" << settings_.eg_filter2_q_enable <<
  //   kSEP; presetzzz << "eg_filter3_freq_enable=" <<
  //   settings_.eg_filter3_freq_enable
  //             << kSEP;
  //   presetzzz << "eg_filter3_q_enable=" << settings_.eg_filter3_q_enable <<
  //   kSEP; presetzzz << "eg_master_freq_enable="
  ...
  //             << kSEP;
  //   presetzzz << "lfo_filter1_freq_enable=" <<
  //   settings_.lfo_filter1_freq_enable
  //             << kSEP;
  //   presetzzz << "lfo_filter1_q_enable=" << settings_.lfo_filter1_q_enable
  //             << kSEP;
  //   presetzzz << "lfo_filter2_freq_enable=" <<
  //   settings_.lfo_filter2_freq_enable
  //             << kSEP;
  //   presetzzz << "lfo_filter2_q_enable=" << settings_.lfo_filter2_q_enable
  //             << kSEP;
  //   presetzzz << "lfo_filter3_freq_enable=" <<
  //   settings_.lfo_filter3_freq_enable
  //             << kSEP;
...
void DrumSynth::PrintSettings(DrumSettings settingz) {
  ...
  //           << std::endl;
  // std::cout << "lfo_filter1_freq_enable:" <<
  // settings_.lfo_filter1_freq_enable
  //           << std::endl;
  // std::cout << "lfo_filter1_q_enable:" << settings_.lfo_filter1_q_enable
  //           << std::endl;
  // std::cout << "lfo_filter2_freq_enable:" <<
  // settings_.lfo_filter2_freq_enable
  //           << std::endl;
