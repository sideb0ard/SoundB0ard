...
const std::unordered_map<std::string, TokenType> keywords{
    {"bpm", SLANG_BPM},           {"dur", SLANG_DURATION},
    {"else", SLANG_ELSE},         {"every", SLANG_EVERY},
    {"false", SLANG_FALSE},       {"fm", SLANG_FM_SYNTH},
    {"fn", SLANG_FUNCTION},       {"for", SLANG_FOR},
    {"gen", SLANG_GENERATOR},     {"setup", SLANG_GENERATOR_SETUP},
    {"run", SLANG_GENERATOR_RUN}, {"granular", SLANG_GRANULAR},
    ...
    {"true", SLANG_TRUE},         {"vel", SLANG_VELOCITY},
    {"vol", SLANG_VOLUME},        {"info", SLANG_INFO},
};
