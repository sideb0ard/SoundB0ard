...
for (i = 0; i < 10; ++i) {};
    ...
    std::vector<std::pair<token::TokenType, std::string>> testTokens = {
        ...
        {token::SLANG_INT, "5"},          {token::SLANG_SEMICOLON, ";"},
        {token::SLANG_INT, "5"},          {token::SLANG_LT, "<"},
        {token::SLANG_INT, "10"},         {token::SLANG_GT, ">"},
        {token::SLANG_INT, "5"},          {token::SLANG_SEMICOLON, ";"},
        {token::SLANG_IF, "if"},          {token::SLANG_LPAREN, "("},
        {token::SLANG_INT, "5"},          {token::SLANG_LT, "<"},
        {token::SLANG_INT, "10"},         {token::SLANG_RPAREN, ")"},
        ...
        {token::SLANG_RBRACE, "}"},       {token::SLANG_INT, "10"},
        {token::SLANG_EQ, "=="},          {token::SLANG_INT, "10"},
        {token::SLANG_SEMICOLON, ";"},    {token::SLANG_INT, "10"},
        {token::SLANG_NOT_EQ, "!="},      {token::SLANG_INT, "9"},
        {token::SLANG_SEMICOLON, ";"},    {token::SLANG_STRING, "foobar"},
        {token::SLANG_STRING, "foo bar"}, {token::SLANG_LBRACKET, "["},
        {token::SLANG_INT, "1"},          {token::SLANG_COMMA, ","},
        {token::SLANG_INT, "2"},          {token::SLANG_RBRACKET, "]"},
